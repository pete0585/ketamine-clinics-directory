...
const NICHE = 'ketamine-clinics' as const
const NEWSLETTER_NAME = 'The Ketamine Courier' as const
const CONFIRM_URL_BASE = 'https://www.ketamineclinicsdirectorynow.com/newsletter/confirm'

...
const RESEND_AUDIENCE_ID = process.env.RESEND_clinic_AUDIENCE_ID ?? 'de3bdf48-7106-4705-a3c1-f88ee18e5f98'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'hello@ketaminetherapyfinder.com',
        to: normalizedEmail,
        subject: 'Welcome — your weekly clinic tips are coming',
        html: `<p>Hi there,</p>
<p>Thanks for signing up. Every week you'll get practical ketamine therapy tips from ketamine clinics, plus new listings near you.</p>
<p>No fluff. No spam. Just real support.</p>
<p>— The clinicDirectory.com team</p>
<p style="font-size:12px;color:#aaa;margin-top:32px;">You signed up at clinicDirectory.com. <a href="https://ketaminetherapyfinder.com">Visit the directory</a>.</p>`,
      }),

...
import { MapPin, Phone, Globe, Video, Home, Building2, ShieldCheck, Star, CheckCircle, Mail, Clock, Languages, Heart, } from 'lucide-react';
    ...
    return (<div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="card p-6 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="shrink-0">
            {listing.photo_url ? (<div className="relative h-28 w-28 rounded-2xl overflow-hidden bg-ivory-200 shadow-soft">
                <Image src={listing.photo_url} alt={listing.full_name} fill className="object-cover" sizes="112px" priority/>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          {(listing.languages_spoken ?? []).length > 0 && (<span className="inline-flex items-center gap-1.5 rounded-full bg-ivory-100 border border-ivory-300 px-3 py-1.5 text-sm text-charcoal-600">
